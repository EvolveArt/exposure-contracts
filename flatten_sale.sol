...
// File contracts/interfaces/IExposureMintPass.sol
...
// File contracts/ContinuousDutchAuction.sol
...
abstract contract ContinuousDutchAuction is Manageable {
    ...
    function verifyBid(uint256 auctionId) internal returns (uint256) {
        ...
        if (msg.value - pricePaid > 0)
            Address.sendValue(payable(msg.sender), msg.value - pricePaid); //refund difference
        return pricePaid;
    }
}
...
// File @openzeppelin/contracts/utils/structs/BitMaps.sol@v4.5.0
...
// File contracts/SalePlatform.sol
